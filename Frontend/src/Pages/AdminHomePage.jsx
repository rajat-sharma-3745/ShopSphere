  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      ...
      {productsLoading || ordersLoading ? (
        ...
        <p><BarLoader color="#f8e71c" /></p></div>
      ) : productsError ? (
        <p className="text-rose-500">
          Error fetching products : {productsError}
        </p>
      ) : ordersError ? (
        <p className="text-rose-500">Error fetching orders : {ordersError}</p>
      ) : (
        <div className="grid grid-cols-1 smF:grid-cols-2 lg:grid-cols-3 gap-6">
