...
function Navbar() {
  ...
  return (
    ...
    <nav className='container mx-auto flex justify-between items-center py-4 px-6 '>
        ...
        <div>
          {/* <img src={Logo} className='w-25 h-12 object-cover' alt="" /> */}
            <Link to='/' className='text-2xl font-semibold flex items-center'><img src={Logo} className='w-9 h-8 object-cover' alt="" />
            ShopSphere</Link>
        </div>   
        {/*center links  */}
    ...
    {/* Mobile navigation */}
    <div className={`fixed top-0 left-0 w-3/4 sm:w-1/2 md:w-1/3 h-full bg-white shadow-lg transform transi duration-300 z-50 
